...
class GoogleDownloaderThread(BaseDownloaderThread):
    ...
    def __init__(self, root_dir, bbox, task_q, logger=None):
        super(GoogleDownloaderThread, self).__init__(root_dir, bbox, task_q, logger)
...
class GoogleDownloadEngine(DownloadEngine):
    ...
    def __init__(self, root_dir, bbox, thread_num, logger):
        super(GoogleDownloadEngine, self).__init__(bbox, thread_num, logger)
    ...
    def generate_metadata(self):
        try:
            ...
            metadatas = {'attribution': 'http://mt{s}.google.cn/vt/lyrs=s&hl=en-US&gl=US&x={x}&y={y}&z={z}',
                         'bounds': bounds,
